 ...
 * the {@link ExistingDriverId} annotation constraint.
 *
 * @author Sergey Khvatov
 */
@Component
public class ExistingDriverIdValidator implements ConstraintValidator<ExistingDriverId, String> {
     ...
     */
    @Autowired
    public ExistingDriverIdValidator(DriverInnerService driverInnerService) {
