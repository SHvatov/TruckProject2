 ...
 * the {@link ExistingTruckId} annotation constraint.
 *
 * @author Sergey Khvatov
 */
@Component
public class ExistingTruckIdValidator implements ConstraintValidator<ExistingTruckId, String> {
     ...
     */
    @Autowired
    public ExistingTruckIdValidator(TruckInnerService truckInnerService) {
