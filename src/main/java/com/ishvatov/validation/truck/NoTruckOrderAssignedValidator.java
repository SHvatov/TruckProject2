 ...
 */
@Component
public class NoTruckOrderAssignedValidator implements ConstraintValidator<NoTruckOrderAssigned, String> {
     ...
     */
    @Autowired
    public NoTruckOrderAssignedValidator(TruckInnerService truckInnerService) {
    ...
    public boolean isValid(String id, ConstraintValidatorContext constraintValidatorContext) {
        return truckInnerService.find(id).getOrderId() == null;
    }
}
